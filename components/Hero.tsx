  ...
  return (
    <div className="relative">
      <div className="bg-[url('/hero2.png')] bg-cover bg-no-repeat bg-center h-[800px]">
        <div className="absolute inset-0 mt-40   sm:mt-0 ">

          <Image className="w-40 h-40 sm:w-[200px] sm:h-[200px]  mt-[10px]" src="/herolefttop.png" alt="not found" width={200} height={200} />
        </div>
        <div className="absolute inset-0 flex flex-col justify-end">

          <Image className="w-40 h-40 sm:w-[200px] sm:h-[200px]   sm:ml-[100px]" src="/heroleftbottom.png" alt="not found" width={200} height={200} />
        </div>

        <div className="absolute inset-0 flex flex-col items-end justify-end">

          <Image className=" w-40 h-40 sm:w-[200px] sm:h-[200px] sm:mt-0" src="/heroright.png" alt="not found" width={200} height={200} />
        </div>
