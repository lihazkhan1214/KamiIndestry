...
<Image className=" ml-[100px]" src="/heroleftbottom.png" alt="not found" width={160} height={160}/>
</div>
...
<div className="absolute inset-0 flex flex-col items-end justify-end">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center">
          ...
          <p className="text-white hidden sm:block mb-5 globalpara text-center">Explore Exclusive Hair Removal, Stainless Steel <br />, Eyelash Tweezers and Mirrors</p>
