            ...
            <div className="py-10 flex justify-center items-center">
                <div className='w-full md:w-[40%] py-5 px-10 bg-[#FFF]'>
                    ...
                    <div className="mt-5 flex flex-wrap md:flex-nowrap gap-5 items-center justify-between ">
                        <Image className='cursor-pointer' onClick={()=>signIn('google')} src="/google.png" alt='not found' width={60} height={60} />
                    ...
                    <h5 className='cursor-pointer mt-5 text-center text-lg font-normal  text-[#333]' onClick={()=>router.push('/register')}>Don’t have an account?<span className='text-[#097DEB]'>Sign up</span></h5>
